...
class Analyse():
    ...
    def gene_analysis(self, RNA_seq_filename, pathway_filename, path, post_data_path, epoch_time):
        ...
        dir_opt = self.dir_opt
        zero_final_dl_input_df, input_num, num_feature, cellline_gene_df, cpnum_df, num_gene, num_pathway = LoadData(dir_opt, RNA_seq_filename).pre_load_train()
        layer0 = num_pathway
        layer1 = 256
        layer2 = 128
        layer3 = 32
        ...
        plt.tight_layout()
        # SAVE TEST PLOT FIGURE
        file_name = 'epoch_' + epoch_time + '_validation_gene_barplot'
